    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-blue-900/20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border border-gray-100 dark:border-gray-800 rounded-2xl overflow-hidden shadow-xl">
          {/* Header Image */}
          <div className="relative w-full h-96 bg-gradient-to-br from-pink-100 to-purple-100 dark:from-gray-800 dark:to-gray-700">
            <Image
              src={pkg.imageUrl}
              alt={pkg.name}
              fill
            ...
            {/* Discount Badge */}
            {pkg.discount > 0 && (
              <div className="absolute top-4 right-4 bg-red-500 text-white px-6 py-3 rounded-xl shadow-lg">
                <span className="text-2xl font-bold">{pkg.discount}% OFF</span>
              </div>
            )}
            {/* Popular Badge */}
            {pkg.popular && (
              <div className="absolute top-4 left-4 bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-6 py-3 rounded-xl shadow-lg font-bold">
                ⭐ MOST POPULAR
              </div>
            )}
          </div>
          ...
          <div className="p-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed mb-3">
                    <strong className="text-amber-700 dark:text-amber-400">Show your OMNI Pass QR code when booking and the discount is automatically applied!</strong>
                  </p>
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-3">
                {pkg.features.map((feature, index) => (
                  <span
                    key={index}
                    className="px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-xl font-medium"
                  >
                    {feature}
                  </span>
                ))}
            ...
            <div className="flex gap-4">
              <Link href={`/sdm/booking?packageId=${pkg.id}`} className="flex-1">
                <button className="w-full bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 hover:from-pink-600 hover:via-purple-700 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-xl transition-all hover:scale-105 shadow-lg text-lg">
                  Book This Package →
                </button>
              </Link>
            </div>
